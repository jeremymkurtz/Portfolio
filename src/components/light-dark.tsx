...
export default function LightDark(props:{size:number, toggle: () => void, theme: string}) {

    return (
        <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 17" width={props.size} height={props.size}
             className="block icons-style mini-icons cursor-pointer" onClick={props.toggle}
                    stroke={"#FFFFFF"}
                    fill={"none"}
                    strokeWidth={"1.5"}
                    strokeLinecap={"round"}
            ...
            <motion.path
                ...
                animate={{y: props.theme=="dark" ?  17 : 0}}
                y={17}
            />
            <motion.g
                id={"sun"}
                ...
                style={{transformOrigin: "0px 0px 0px"}}
                animate={{y: props.theme=="light" ? 17 : 0}}
            >
